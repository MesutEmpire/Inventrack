...
<template>
  <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div class="flex items-center md:order-2">
        <div v-if="!store.getCurrentUser">
          <router-link to="/login">
            <button type="submit"
                    class="text-white bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:outline-none focus:ring-pink-500 font-medium rounded-lg text-sm lg:text-base w-full sm:w-auto px-5 py-2.5 text-center ">Log In</button>
      ...
      <div v-if="false" class="flex items-center md:order-2">
        ...
        <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow">
          ...
          <ul class="py-1" >
            ...
            <li>
              <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Notification</a>
            </li>
            <li>
...
<!--        </button>-->
      ...
      <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
          <li>
            <a href="#" class="block text-xl py-2  pr-4 pl-3 text-white  rounded md:bg-transparent md:text-primary md:p-0" aria-current="page">Home</a>
          </li>
          <li>
            <a href="#" class="block text-xl py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-text-primary md:p-0 ">About</a>
          </li>
          <li>
            <a href="#" class="block text-xl py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-text-primary md:p-0 ">Services</a>
          </li>
          <li>
            <a href="#" class="block text-xl py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-text-primary md:p-0 ">Pricing</a>
          </li>
          <li>
            <a href="#" class="block text-xl py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-text-primary md:p-0 ">Contact</a>
          </li>
        </ul>
      </div>
    </div>
...
import {UserAuthStore} from "@/stores/userAuthStore";
    ...
    // store.authState()
// watchEffect(()=>{
//   console.log("Watching",store.getCurrentUser)
// })
